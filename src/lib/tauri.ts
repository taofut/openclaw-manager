...
export const api = {
  ...
  // 安装器
  checkEnvironment: () => invokeWithLog<EnvironmentStatus>('check_environment'),
  installNodejsBat: () => invokeWithLog<InstallResult>('install_nodejs_bat'),
  installGitBat: () => invokeWithLog<InstallResult>('install_git_bat'),
  installOpenclawBat: () => invokeWithLog<InstallResult>('install_openclaw_bat'),
  uninstallAllBat: () => invokeWithLog<InstallResult>('uninstall_all_bat'),
  checkOpenclawUpdate: () => invokeWithLog<UpdateInfo>('check_openclaw_update'),
  updateOpenclaw: () => invokeWithLog<InstallResult>('update_openclaw'),

  // Dashboard
  getDashboardUrl: () => invokeWithLog<string>('get_dashboard_url'),
};
